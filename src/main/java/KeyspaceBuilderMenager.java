...
public class KeyspaceBuilderMenager extends SimpleMenager {
    private String keyspaceName;

    public KeyspaceBuilderMenager(CqlSession session, String keyspaceName) {
        super(session);
        this.keyspaceName = keyspaceName;
    }

    public KeyspaceBuilderMenager(CqlSession session) {
        super(session);
    }
